...
$archive_social_share_on =zinco_get_opt( 'archive_social_share_on', false );
?>
            ...
            <div class="entry-body-inner">
                ...
                <div class="entry-footer">
                    <div class="entry-readmore">
                        <a class="btn btn-aylen" href="<?php echo esc_url( get_permalink()); ?>"><?php echo esc_html__('Read More', 'zinco'); ?><i class="fa fa-angle-double-right"></i></a>
                    </div>
                    <?php if($archive_social_share_on == true) : ?>
                        <div class="entry-social-share">
                            <span><i class="far fac-share-alt"></i></span>
                            <?php zinco_socials_share_archive(); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
