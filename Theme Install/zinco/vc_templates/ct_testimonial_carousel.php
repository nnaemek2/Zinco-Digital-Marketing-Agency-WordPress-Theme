...
if(!empty($testimonials)) : ?>
    ...
    <div id="<?php echo esc_attr($html_id);?>" class="ct-testimonial-layout1 owl-carousel <?php echo esc_attr( $el_class ); ?>" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
