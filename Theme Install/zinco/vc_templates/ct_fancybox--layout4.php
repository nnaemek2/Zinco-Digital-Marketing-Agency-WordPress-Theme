...
?>
<div class="ct-fancybox-layout4 <?php echo esc_attr($box_bg_color.' '.$el_class.' '.$animation_classes); ?>">
	<div class="ct-fancybox-inner">
        ...
        <div class="ct-fancybox-meta">
            ...
            <?php if(!empty($item_content)) : ?>
                <div class="ct-fancybox-item-content">
        ...
        <?php if($icon_class):?>
            <div class="ct-fancybox-icon-overlay">
