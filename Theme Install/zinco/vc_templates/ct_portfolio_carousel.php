...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-portfolio-layout1 owl-carousel images-light-box <?php echo esc_attr($el_class); ?>" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
                    ...
                    <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)) : ?>
                        <div class="item-featured">
                            ...
                            <div class="item-link">
                                ...
                                <a class="light-box" href="<?php echo esc_url($thumbnail_url[0]); ?>"><i class="fac fac-search"></i></a>
                                <a class="more-link" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><i class="fac fac-link"></i></a>
                            </div>
                        </div>
                    <?php endif; ?>
